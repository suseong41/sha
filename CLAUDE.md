...
go test ./...           # 589개 (서브테스트 포함) · 주입 테스트 포함 약 7초
...
```
규칙 23종 · 테스트 589개 · 정상 코퍼스 17쪽 · 퍼징 5,600만 케이스 무결
...
1. **다음 방향 미정** — 남은 보류: foster parenting(트리) · eTLD+1 표 확장 · 시험받지 않은 규칙 17종 ·
   단일 체계 위조. 코퍼스를 더 넓히는 것도 선택지.
